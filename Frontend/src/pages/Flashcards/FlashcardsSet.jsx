          ...
          <Link to={`${path.pathname}/learn`}>
            <div className="relative ">
              <div className="relative z-3 top-0 left-0 h-[200px] w-[80vw]  sm:h-[300px] sm:w-[540px] lg:h-[350px] lg:w-[800px] ">
                <Flashcard
                  definition={flashcards[params.subject][0].definition}
                  explanation={flashcards[params.subject][0].explanation}
                  turnOff={true}
                ></Flashcard>
              </div>
              <div className="absolute z-2 top-[15px] left-[-15px] sm:top-[20px] sm:left-[-20px] h-[200px] w-[80vw]  sm:h-[300px] sm:w-[540px] lg:h-[350px] lg:w-[800px] ">
                <Flashcard
                  definition={flashcards[params.subject][1].definition}
                  explanation={flashcards[params.subject][1].explanation}
                  turnOff={true}
                ></Flashcard>
              </div>
              {flashcards[2] && (
                <div className="absolute z-1 top-[30px] left-[-30px] sm:top-[40px] sm:left-[-40px] h-[200px] w-[80vw]  sm:h-[300px] sm:w-[540px] lg:h-[350px] lg:w-[800px]">
                  <Flashcard
                    definition={flashcards[params.subject][2].definition}
                    explanation={flashcards[params.subject][2].explanation}
                    turnOff={true}
                  ></Flashcard>
                </div>
              )}
