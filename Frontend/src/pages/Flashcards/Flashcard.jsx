...
function Flashcard({ definition, explanation, turnOff = false }) {
  const [flipped, setFlipped] = useState(false);
  return (
    <div className="h-[200px] w-[100%] sm:h-[300px] sm:w-[540px] lg:h-[350px] lg:w-[800px]  text-white   perspective-distant transition-all duration-900 ease-in">
      <div
        className={`relative w-full h-full transition-transform transform-3d

   ${flipped ? "rotate-y-180  " : ""}`}
        onClick={() => (!turnOff ? setFlipped(!flipped) : "")}
      >
        <div
