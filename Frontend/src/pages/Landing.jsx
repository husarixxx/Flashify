  ...
  return (
    <div className="min-h-[100vh] flex flex-col justify-between">
      ...
      <main className="text-center px-4 lg:py-6">
        ...
        <button className=" my-8 text-white text-xl lg:text-2xl font-bold bg-purple-500 py-2.5 px-12 rounded-3xl shadow-lg opacity-88 hover:cursor-pointer hover:opacity-100 transition-opacity">
          Get Started
        </button>
      </main>
      <Footer></Footer>
